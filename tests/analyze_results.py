...
def download_and_extract_kaggle_dataset():
    ...
    download_path = r'C:\Proyectos\movies-proyect-poetry\ml_movies\data\raw'
...
# Ruta del directorio
directorio = r'C:\Proyectos\movies-proyect-poetry\ml_movies\data\external'
...
directorios = {
    'X_train': r'C:\Proyectos\movies-proyect-poetry\ml_movies\data\processed',
    'X_test': r'C:\Proyectos\movies-proyect-poetry\ml_movies\data\processed',
    'y_train': r'C:\Proyectos\movies-proyect-poetry\ml_movies\data\processed',
    'y_test': r'C:\Proyectos\movies-proyect-poetry\ml_movies\data\processed'
}
...
ruta_destino = r'C:\Proyectos\movies-proyect-poetry\ml_movies\tests'
